...
def create_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("-h", "--header", action="append", help="HTTP header for remote spec retrieval (format: 'Name: Value')")
    parser.add_argument("--py-version", type=float, default=3.13, help="Target Python version compatibility")
