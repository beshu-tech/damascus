...
The generated SDK will include a Client class that supports:
- Custom headers
...
def main():
    ...
    print("\n# Using the generated client with custom headers and request timeout:")
    print(
        """
from my_proj_sdk_pkgname import Client
